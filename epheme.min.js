if(!Object.create)Object.create=function(l){function k(){}k.prototype=l;return new k};
(function(l){function k(c,h,g){var d=c.length,b;for(b=0;b<d;++b)c[b].impl(h,g)}function w(c,h){var g=c.length,d=this.name,b=[],a;if(d.local)for(a=0;a<g;++a)b.push(c[a].appendChild(document.createElementNS(d.space,d.local)));else for(a=0;a<g;++a)b.push(c[a].appendChild(document.createElement(d)));k(this.actions,b,h)}function x(c,h){var g=c.length,d=this.name,b=this.value,a,f,e;if(d.local)if(b==null)for(a=0;a<g;++a)c[a].removeAttributeNS(d.space,d.local);else if(typeof b=="function")for(a=0;a<g;++a){i[0]=
h[a];f=c[a];e=b.apply(null,i);e==null?f.removeAttributeNS(d.space,d.local):f.setAttributeNS(d.space,d.local,e)}else for(a=0;a<g;++a)c[a].setAttributeNS(d.space,d.local,b);else if(b==null)for(a=0;a<g;++a)c[a].removeAttribute(d);else if(typeof b=="function")for(a=0;a<g;++a){i[0]=h[a];f=c[a];e=b.apply(null,i);e==null?f.removeAttribute(d):f.setAttribute(d,e)}else for(a=0;a<g;++a)c[a].setAttribute(d,b)}function y(c){var h=this.value,g=c.length,d,b=this.key,a,f,e,j,n=[],r=[],s=[],t=[],u=[],v=[],m,o;if(typeof h==
"function"){a=i.shift();h=h.apply(null,i);i.unshift(a)}d=h.length;if(b){a=b.name;f=b.value;m={};o={};if(a.local)for(b=0;b<g;++b){j=c[b];e=j.getAttributeNS(a.space,a.local);if(e!=null)m[e]=j}else for(b=0;b<g;++b){j=c[b];e=j.getAttribute(a);if(e!=null)m[e]=j}for(b=0;b<d;++b){i[0]=a=h[b];e=f.apply(null,i);if(e!=null)o[e]=a}for(e in o){a=o[e];if(e in m){s.push(m[e]);t.push(a)}else{n.push(p[0]);r.push(a)}}for(e in m)if(!(e in o)){u.push(m[e]);v.push(null)}}else{e=d<g?d:g;for(b=0;b<e;++b){s.push(c[b]);
...
b,a)}function D(c,h){var g=c.length,d=this.value,b,a,f;if(typeof d=="function")for(b=0;b<g;++b){i[0]=h[b];f=d.apply(null,i);for(a=c[b];a.lastChild;)a.removeChild(a.lastChild);a.appendChild(document.createTextNode(f))}else for(b=0;b<g;++b){for(a=c[b];a.lastChild;)a.removeChild(a.lastChild);a.appendChild(document.createTextNode(d))}}l=(l.org||(l.org={})).epheme={};l.version="0.0.0";var q={prefix:{svg:"http://www.w3.org/2000/svg",xhtml:"http://www.w3.org/1999/xhtml",xlink:"http://www.w3.org/1999/xlink",
xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"},resolve:function(c){return q.prefix[c]||null},qualify:function(c){var h=c.indexOf(":");return h<0?c:{space:q.prefix[c.substring(0,h)],local:c.substring(h+1)}}},i=[],p=[],E=[];l.transform=function(){function c(d){var b=Object.create(h);b.data=function(a){var f,e={impl:y,value:a,actions:[],enterActions:[],exitActions:[]};d.push(e);f=c(e.actions);f.enter=c(e.enterActions);f.exit=c(e.exitActions);f.key=function(j,n){e.key=
