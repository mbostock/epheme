...
(function(C){function z(a){return function(e){return 1-a(1-e)}}function I(a){return function(e){return 0.5*(e<0.5?a(2*e):2-a(2-2*e))}}function Q(a){return a}function E(a){return function(e){return Math.pow(e,a)}}function R(a){return 1-Math.cos(a*Math.PI/2)}function S(a){return a?Math.pow(2,10*(a-1))-0.0010:0}function T(a){return 1-Math.sqrt(1-a*a)}function U(a){return a<1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+0.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+0.9375:7.5625*(a-=2.625/2.75)*a+0.984375}
function J(a){return a in V||/\bcolor\b/.test(a)?k.tweenRgb:k.tween}function W(a,e,g){function h(c){if(c>360)c-=360;else if(c<0)c+=360;if(c<60)return b+(d-b)*c/60;if(c<180)return d;if(c<240)return b+(d-b)*(240-c)/60;return b}var b,d;a%=360;if(a<0)a+=360;e=e<0?0:e>1?1:e;g=g<0?0:g>1?1:g;d=g<=0.5?g*(1+e):g+e-g*e;b=2*g-d;return{r:Math.round(h(a+120)*255),g:Math.round(h(a)*255),b:Math.round(h(a-120)*255)}}function F(a){var e=parseFloat(a);return a.charAt(a.length-1)=="%"?Math.round(e*2.55):e}function K(){function a(h,
b){var d=Object.create(e);d.pop=h;d.data=function(c){var f,i={impl:X,value:c,actions:[],enterActions:[],exitActions:[]};b.push(i);f=a(d,i.actions);f.enter=a(d,i.enterActions);f.exit=a(d,i.exitActions);f.key=function(m,o){i.key={name:v.qualify(m),value:o};return f};return f};d.attr=function(c,f){b.push({impl:Y,name:v.qualify(c),value:f});return d};d.tweenAttr=function(c,f,i){b.push({impl:Z,name:v.qualify(c),value:f,tween:arguments.length<3?J(c):i});return d};d.style=function(c,f,i){b.push({impl:$,
name:c,value:f,priority:arguments.length<3?null:i});return d};d.tweenStyle=function(c,f,i,m){b.push({impl:aa,name:c,value:f,priority:arguments.length<3?null:i,tween:arguments.length<4?J(c):m});return d};d.add=function(c,f){var i={impl:ba,name:v.qualify(c),value:f,actions:[]};b.push(i);return a(d,i.actions)};d.remove=function(c){b.push({impl:ca,selector:c});return d};d.text=function(c){b.push({impl:da,value:c});return d};d.on=function(c){c={impl:ea,type:c,actions:[]};b.push(c);return a(d,c.actions)};
...
x}function g(){var x=j,u=a.filter(function(ha){return ha.node.interval==n}),D=u.length,G=Date.now(),y,O=true;try{j=H;for(l=0;l<D;++l){s=u[l];y=(G-c-s.delay)/o;if(!(y<0)){if(y>1)y=1;else O=false;k.time=q(y);for(t=0;t<r;++t)b[t].impl([s]);if(y==1){for(t=0;t<w;++t)d[t].impl([s]);s.delay=Infinity}}}}finally{delete k.time;j=x}O&&clearInterval(n)}function h(){var x=j,u=(Date.now()-c-f)/o,D=a.filter(function(G){return G.node.interval==n});try{j=H;k.time=q(u<0?0:u>1?1:u);for(l=0;l<r;++l)b[l].impl(D)}finally{delete k.time;
j=x}if(u>=1){clearInterval(n);try{j=H;for(l=0;l<w;++l)d[l].impl(D)}finally{j=x}}}var b=this.actions,d=this.endActions,c=Date.now(),f=this.delay,i=Infinity,m=-Infinity,o=this.duration,q=this.ease,n,r=b.length,w=d.length,N=a.length,l,t,s,A,H=j.slice();if(typeof f=="function"){for(l=0;l<N;++l){j[0]=(s=a[l]).data;A=s.delay=f.apply(s,j);if(A<i)i=A;if(A>m)m=A}setTimeout(function(){e(n=setInterval(g,24))},i)}else setTimeout(function(){e(n=setInterval(h,24))},f)}var k=(C.org||(C.org={})).epheme={};k.version=
...
e):a;e=e>=0?a.substring(e+1):"in";return la[e](ka[g].apply(null,Array.prototype.slice.call(arguments,1)))};k.tween=function(a,e){var g=ma.exec(a)[1];a=parseFloat(a);e=parseFloat(e)-a;return g.length?function(){return a+e*k.time+g}:function(){return a+e*k.time}};var ma=/[-+]?\d*\.?\d*(?:[eE]\d+)?(.*)/,V={background:1,fill:1,stroke:1};k.tweenRgb=function(a,e){a=k.rgb(a);e=k.rgb(e);var g=a.r,h=a.g,b=a.b,d=e.r-g,c=e.g-h,f=e.b-b;return function(){var i=k.time;return"rgb("+Math.round(g+d*i)+","+Math.round(h+
c*i)+","+Math.round(b+f*i)+")"}};k.rgb=function(a){var e,g,h,b,d;if(b=/([a-z]+)\((.*)\)/i.exec(a)){d=b[2].split(",");switch(b[1]){case "hsl":return W(parseFloat(d[0]),parseFloat(d[1])/100,parseFloat(d[2])/100);case "rgb":return{r:F(d[0]),g:F(d[1]),b:F(d[2])}}}if(b=B[a])return b;if(a==null)return B.black;if(a.charAt(0)=="#"){if(a.length==4){e=a.charAt(1);e+=e;g=a.charAt(2);g+=g;h=a.charAt(3);h+=h}else if(a.length==7){e=a.substring(1,3);g=a.substring(3,5);h=a.substring(5,7)}e=parseInt(e,16);g=parseInt(g,
16);h=parseInt(h,16)}return{r:e,g:g,b:h}};var B={aliceblue:"#f0f8ff",antiquewhite:"#faebd7",aqua:"#00ffff",aquamarine:"#7fffd4",azure:"#f0ffff",beige:"#f5f5dc",bisque:"#ffe4c4",black:"#000000",blanchedalmond:"#ffebcd",blue:"#0000ff",blueviolet:"#8a2be2",brown:"#a52a2a",burlywood:"#deb887",cadetblue:"#5f9ea0",chartreuse:"#7fff00",chocolate:"#d2691e",coral:"#ff7f50",cornflowerblue:"#6495ed",cornsilk:"#fff8dc",crimson:"#dc143c",cyan:"#00ffff",darkblue:"#00008b",darkcyan:"#008b8b",darkgoldenrod:"#b8860b",
...
sandybrown:"#f4a460",seagreen:"#2e8b57",seashell:"#fff5ee",sienna:"#a0522d",silver:"#c0c0c0",skyblue:"#87ceeb",slateblue:"#6a5acd",slategray:"#708090",slategrey:"#708090",snow:"#fffafa",springgreen:"#00ff7f",steelblue:"#4682b4",tan:"#d2b48c",teal:"#008080",thistle:"#d8bfd8",tomato:"#ff6347",turquoise:"#40e0d0",violet:"#ee82ee",wheat:"#f5deb3",white:"#ffffff",whitesmoke:"#f5f5f5",yellow:"#ffff00",yellowgreen:"#9acd32"};for(var P in B)B[P]=k.rgb(B[P]);var j=[];k.select=function(a){return K().select(a)};
k.selectAll=function(a){return K().selectAll(a)}})(this);
