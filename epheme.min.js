...
c*i)+","+Math.round(b+f*i)+")"}};k.rgb=function(a){var e,g,h,b,d;if(b=/([a-z]+)\((.*)\)/i.exec(a)){d=b[2].split(",");switch(b[1]){case "hsl":return W(parseFloat(d[0]),parseFloat(d[1])/100,parseFloat(d[2])/100);case "rgb":return{r:F(d[0]),g:F(d[1]),b:F(d[2])}}}if(b=D[a])return b;if(a.charAt(0)=="#"){if(a.length==4){e=a.charAt(1);e+=e;g=a.charAt(2);g+=g;h=a.charAt(3);h+=h}else if(a.length==7){e=a.substring(1,3);g=a.substring(3,5);h=a.substring(5,7)}e=parseInt(e,16);g=parseInt(g,16);h=parseInt(h,16)}return{r:e,
g:g,b:h}};var D={aliceblue:"#f0f8ff",antiquewhite:"#faebd7",aqua:"#00ffff",aquamarine:"#7fffd4",azure:"#f0ffff",beige:"#f5f5dc",bisque:"#ffe4c4",black:"#000000",blanchedalmond:"#ffebcd",blue:"#0000ff",blueviolet:"#8a2be2",brown:"#a52a2a",burlywood:"#deb887",cadetblue:"#5f9ea0",chartreuse:"#7fff00",chocolate:"#d2691e",coral:"#ff7f50",cornflowerblue:"#6495ed",cornsilk:"#fff8dc",crimson:"#dc143c",cyan:"#00ffff",darkblue:"#00008b",darkcyan:"#008b8b",darkgoldenrod:"#b8860b",darkgray:"#a9a9a9",darkgreen:"#006400",
...
seashell:"#fff5ee",sienna:"#a0522d",silver:"#c0c0c0",skyblue:"#87ceeb",slateblue:"#6a5acd",slategray:"#708090",slategrey:"#708090",snow:"#fffafa",springgreen:"#00ff7f",steelblue:"#4682b4",tan:"#d2b48c",teal:"#008080",thistle:"#d8bfd8",tomato:"#ff6347",turquoise:"#40e0d0",violet:"#ee82ee",wheat:"#f5deb3",white:"#ffffff",whitesmoke:"#f5f5f5",yellow:"#ffff00",yellowgreen:"#9acd32"};for(var P in D)D[P]=k.rgb(D[P]);var j=[];k.select=function(a){return K().select(a)};k.selectAll=function(a){return K().selectAll(a)}})(this);
